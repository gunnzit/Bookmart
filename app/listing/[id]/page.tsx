...
export default function ListingPage() {
  ...
  const css = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .share-wa-btn { background: #E7F9EE; border: 1.5px solid #B2E8D6; border-radius: 10px; padding: 7px 13px; font-size: 12px; font-weight: 600; cursor: pointer; color: #1D9E75; transition: all 0.15s; display: flex; align-items: center; gap: 5px; }
    .share-wa-btn:hover { background: #D1FAE5 !important; }
    .report-btn { background: var(--bg-card); border: 1.5px solid var(--border); border-radius: 10px; padding: 7px 13px; font-size: 12px; font-weight: 600; cursor: pointer; color: var(--text-secondary); transition: all 0.15s; display: flex; align-items: center; gap: 5px; }
