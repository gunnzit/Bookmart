      ...
      <div style={{ minHeight: '100vh', background: '#FAFAF8' }}>
        <nav style={{ background: '#fff', borderBottom: '1.5px solid #EDE9E1', padding: '0 24px', height: '64px', display: 'flex', alignItems: 'center', gap: '16px', position: 'sticky', top: 0, zIndex: 50, boxShadow: '0 2px 12px rgba(27,42,74,0.05)' }}>
          ...
          <div ref={searchRef} style={{ flex: 1, position: 'relative', maxWidth: '500px' }}>
            <div style={{ display: 'flex', alignItems: 'center', background: '#FAFAF8', border: '1.5px solid #EDE9E1', borderRadius: '14px', padding: '0 14px', height: '40px', gap: '8px' }}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '10px' }}>
            {isSignedIn ? (
              <>
                ...
                <button className="sell-btn" onClick={() => window.location.href = '/sell'} style={{ background: '#1D9E75', color: '#fff', border: 'none', borderRadius: '12px', padding: '9px 20px', fontWeight: '600', cursor: 'pointer', fontSize: '14px', fontFamily: 'Kalam, cursive', boxShadow: '0 3px 12px rgba(29,158,117,0.25)', transition: 'all 0.15s' }}>
                  + Sell
                </button>
                <UserButton />
              </>
